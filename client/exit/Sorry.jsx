        ...
        switch (player.exitStatus) {
            case "gameFull":
                msg = "All games you are eligible for have filled up too fast. "
                        + "If you wait a minute and refresh, another game may become available. Or...";
                break;
            ...
            case "playerEndedLobbyWait":
                ...
                break;
            default:
                msg = "Unfortunately the Game was cancelled. Please provide your MTurk ID "
                        + "as the completion code, so that I can still pay you for your time. " 
                        + "I greatly apologize.";
                break;
        }
