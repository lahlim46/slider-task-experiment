    ...
    return (
      <Centered>
        <div className="instructions">
          ...
          <p>
            You will receive a base pay of $2.50 for completing the HIT. In addition to the 
          ...
          <p>
            <b>Bonuses are in addition to the $2.50 base pay and will be determined as follows:</b>
          </p>
          <ul>
            <li>Participant with the highest average score: $3.50</li>
            <li>Second highest average score: $3</li>
            <li>Third highest average score: $2.50</li>
            <li>Top half of participants but not in the top three: $1.50</li>
            <li>Bottom half of participants but not in the bottom three: $1.00</li>
            <li>Third to last: $0.50</li>
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            {game.treatment.feedbackType === "relative" && (
              <div className="multiple-choice">
                <label>
                  <b>Q3:</b> 
                  The participant ranked in 1st is the participant that performed the best in that round.
                </label>
                <div>
                  <Radio
                    selected={q3}
